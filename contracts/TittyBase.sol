...
contract TittyBase {
    ...
    event Creation(address indexed from, uint256 tittyId);
    ...
    function _likeTitty (uint256 _tittyId) internal {
    ...
    function createTitty (uint32 _id, string _gender, uint256 _price, address _owner, string _name) internal returns (uint) {
